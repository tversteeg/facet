...
[![crates.io](https://img.shields.io/crates/v/facet-derive-emit.svg)](https://crates.io/crates/facet-derive-emit)
[![documentation](https://docs.rs/facet-derive-emit/badge.svg)](https://docs.rs/facet-derive-emit)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/facet-derive-emit.svg)](./LICENSE)
...
Emits Rust code for [facet-derive](https://github.com/facet-rs/facet/tree/main/facet-derive)
