...
impl PrettyPrinter {
    ...
    fn write_type_name<W: fmt::Write>(&self, f: &mut W, peek: &PeekValue) -> fmt::Result {
        struct TypeNameWriter<'a, 'b: 'a>(&'b PeekValue<'a>);
    ...
    #[allow(dead_code)]
    fn style_type_name(&self, peek: &PeekValue) -> String {
